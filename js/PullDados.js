    ...
    projetos.forEach(projeto => {
      ...
      div.innerHTML = `
          ...
          <div class="card-center">
            <h2 class="cor-n0">${projeto.titulo}</h2>
            <p class="cor-n4">${projeto.descricao}
            </p>
          </div>
          <div class="card-end">
            ...
            <div class="habilidades-links">
              <a href="${projeto.github}" aria-label="Link do repositorio" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                  id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;"
                  xml:space="preserve" width="512" height="512" class="svg" alt="Ver repositório">
                  <g>
              ...
              <a href="${projeto.deploy}" target="_blank" aria-label="Ver Deploy do projeto">
                <p>Ver Web</p>

(()=>{fetch("https://mellonickolas.github.io/Portfolio/dados/projetos.json").then(e=>e.json()).then(e=>{let o=document.getElementById("projetosContainer");o&&e.forEach(s=>{let c=document.createElement("div");c.classList.add("card"),c.innerHTML=`
          <div class="card-start">
            <img src="${s.imagem}" alt="${s.titulo}">        
          </div>
          <div class="card-center">
            <h2 class="cor-n0">${s.titulo}</h2>
            <p class="cor-n4">${s.descricao}
            </p>
          </div>
          <div class="card-end">
            ...
            <div class="habilidades">
              ${s.linguagens.map(a=>`
                <p class="${a==="responsivo"?"responsivo":""}">${a}</p>
              `).join("")}
            </div>

            <div class="habilidades-links">
              <a href="${s.github}" aria-label="Link do repositorio" target="_blank">
              ...
              <a href="${s.deploy}" target="_blank" aria-label="Ver Deploy do projeto">
                <p>Ver Web</p>
          ...
          `,o.appendChild(c)})});var n=document.querySelectorAll(".hiddenUp"),r=new IntersectionObserver(e=>{e.forEach(o=>{o.isIntersecting?o.target.classList.add("show"):o.target.classList.remove("show")})});n.forEach(e=>r.observe(e));var l=document.getElementById("openModalBtn"),d=document.getElementById("closeModalBtn"),t=document.getElementById("modalOverlay");l&&d&&t&&(l.addEventListener("click",()=>{t.classList.add("show")}),d.addEventListener("click",()=>{t.classList.remove("show")}),t.addEventListener("click",e=>{e.target===t&&t.classList.remove("show")}));var i=document.getElementById("backToTop");window.addEventListener("scroll",()=>{window.scrollY>300?i.classList.add("show"):i.classList.remove("show")});i.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});console.log(`%c
  \u2588\u2588\u2588\u2557   \u2588\u2588\u2557\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2557  \u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2557      \u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557
  \u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2551 \u2588\u2588\u2554\u255D\u2588\u2588\u2554\u2550\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2551     \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D
  \u2588\u2588\u2554\u2588\u2588\u2557 \u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2588\u2588\u2588\u2554\u255D \u2588\u2588\u2551   \u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557
  \u2588\u2588\u2551\u255A\u2588\u2588\u2557\u2588\u2588\u2551\u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2554\u2550\u2588\u2588\u2557 \u2588\u2588\u2551   \u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551\u255A\u2550\u2550\u2550\u2550\u2588\u2588\u2551
